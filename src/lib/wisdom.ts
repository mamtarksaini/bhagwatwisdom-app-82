...
type WisdomResponse = {
  ...
  isDirectApiUsed?: boolean; // Added this missing property
  errorDetails?: string;
}
...
export const fallbackWisdomResponses = {
  ...
  hindi: {
    ...
    default: "अपना प्रश्न साझा करने के लिए धन्यवाद। भगवद गीता ऐसा ज्ञान प्रदान करती है जो हमारी आधुनिक चुनौतियों के लिए उल्लेखनीय रूप से प्रासंगिक बना हुआ है।\n\nइसकी सबसे शक्तिशाली शिक्षाओं में से एक यह है कि हम बाहरी परिस्थितियों को नियंत्रित करके नहीं, बल्कि उनके साथ अपने संबंध को बदलकर शांति पाते हैं। जैसा कि कृष्ण अर्जुन से कहते हैं, 'आपका नियंत्रण केवल अपने कर्मों पर है, कभी भी परिणामों पर नहीं।'\n\nयह दृष्टिकोण हमें आमंत्रित करता है:\n1. जो हम नियंत्रित नहीं कर सकते उस पर नहीं बल्कि जिसे हम प्रभावित कर सकते हैं उस पर ध्यान केंद्रित करें\n2. चुनौतियों को बाधाओं के बजाय विकास के अवसरों के रूप में देखें\n3. बिना परिणामों से अत्यधिक जुड़े हुए वर्तमान क्षण में पूरी तरह उपस्थित रहें\n\nमार्गदर्शन की तलाश करने की आपकी इच्छा बुद्धिमत्ता दिखाती है। विश्वास रखें कि आपके पास इस स्थिति को शक्ति और करुणा दोनों के साथ नेविगेट करने के लिए आंतरिक संसाधन हैं।"
  }
};
